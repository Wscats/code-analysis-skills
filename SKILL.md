...
## 💬 Use as a Skill Plugin (Easiest Way)

As a Skill plugin, you can trigger analysis directly in a conversation — no commands needed:

```
"Analyze Alice's development efficiency in /path/to/repo"
"Show me the team's work habits in this project"
"Compare Alice and Bob's code quality in /path/to/repo"
"What's the slacking index of /path/to/repo?"
"Generate a full developer evaluation report for /path/to/repo"
```
...
The Skill will run the analysis on the specified repository and return a structured report. Just talk to it naturally.
